...
const RightPanel: React.FC<Props> = ({ visible }) => (
  <Drawer title="Properties" visible={visible}>
    <div className={styles.rightPanelContainer}>
      ...
      <Row>
        <p className={styles.content}>
          ...
          are interested in advancing a career or need to better understand how
          a business is run. Students will further their customer service skills
          and understand merchandising, marketing, store operations, inventory
          management, loss prevention and workplace safety. They will master
          math concepts, including determining pricing strategies and
          calculating profit and discounts. They will also learn best practices
          for how to plan for a career and get promoted.
        </p>
      </Row>
      <Row className={styles.buttonContainer}>
        <Button

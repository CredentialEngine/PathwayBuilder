...
export interface Props {
  ...
  setIsShowToolTip?: (val: any) => void;
  getTooltipType?: (val: any) => void;
}
...
const CardWithLeftIcon: React.FC<Props> = (props: Props) => {
  ...
  useEffect(() => {
    setIsShowToolTip && setIsShowToolTip(showToolTip);
    getTooltipType && getTooltipType(data?.Type);
  }, [showToolTip, data]);
